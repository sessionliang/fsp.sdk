...
namespace FusionPay\Kernel\Log;
...
{
    /**
     * @var \FusionPay\Kernel\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \FusionPay\Kernel\ServiceContainer $app
     */
    ...
    {
        return new Monolog('FusionPay', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/fusionpay/fusionpay.log', $this->level(['level' => 'debug'])
        )]));
    }
    ...
    protected function createSyslogDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SyslogHandler(
                    'FusionPay', $config['facility'] ?? LOG_USER, $this->level($config))
            ),
        ]);
    }
